...
Nun zur Erkl"arung des Vorgehens: der Widerstand $R_1$ ist variabel, w"arend $R_x$ den zu messenden Widerstand darstellt. Wir "andern den Widerstand $R_1$ so lange ab, bis keine Spannung mehr durch das Voltmeter flieﬂt. Da die Widerst"ande $R_1$, $R_2$ und $R_3$ bekannt sind, k"onnen wir mittels Gleichung \eqref{eq:wheaton} den Wert des unbekannten Widerstands $R_x$ ausrechnen.
