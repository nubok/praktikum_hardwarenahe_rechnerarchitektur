...
\begin{itemize}
\item Alterungserscheinungen der Messgeräte
\item bei Digitalmessgeräten Vortäuschung einer Messpräzision durch viele angegebene Dezimalstellen, welche über der tatsächlichen Genauigkeit des Messgeräts liegt
\item bei der Wheatstone'schen Messbrücke nicht ganz präzise Einstellung auf den Nullpunkt aufgrund der Handhabung des Messgeräts
\item Erwärmung der Leiter infolge des Stromflusses führt zu veränderten Widerstandswerten
