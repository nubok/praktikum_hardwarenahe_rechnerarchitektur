...
Wir haben uns, da dies der Anzeige von \verb|Debug| auf dem Bildschirm entspricht, daf"ur entschieden, dass die Verwendung eines \verb|-| am Anfang einer Zeile bedeuten soll, dass dies -- bis zum Ende der Zeile -- von uns so eingegeben wurde. Den Rest der hier dokumentierten Screendumps sollen die Ausgaben von \verb|debug| darstellen.
...
\verb|si| liefert folgende Informationen:
...
\hline
Nummer & Name & Adresse & Name & Besitzer \\
\hline
\verb|0B| & IRQ 03 & \verb|0DCA:006F| & \verb|COM2| & DOS \\
\verb|0C| & IRQ 04 & \verb|0DCA:0087| & \verb|COM1| & DOS \\
\verb|0F| & IRQ 7 - Drucker & \verb|0070:06F4| & \verb|LPT1| & Unbekannt \\
\verb|17| & Drucker & \verb|0070:06F4| & \verb|BIOS| & \\ 
\hline
\end{tabular}
...
Als ersten Schritt initialisieren wir das Steuerwort 
