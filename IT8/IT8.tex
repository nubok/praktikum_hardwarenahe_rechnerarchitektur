...
\end{pspicture}
\end{center}
\caption{Zeitmultiplexbetrieb der ADU-Kanäle -- Hauptstruktur Programm}
\label{abb:aufgabe34_main}
\end{figure}

\begin{figure}
\lstinputlisting[caption={Assembler-Programm f"ur Zeitmultiplexbetrieb der ADU-Kanäle -- Hauptschleife}, language=z8asm, label=lsg:aufgabe34_main, firstline=13, lastline=22, firstnumber=13]{aufgabe34.asm}
\end{figure}
...
\end{pspicture}
\end{center}
\caption{Zeitmultiplexbetrieb der ADU-Kanäle -- Funktion \texttt{read\_loop}}
\label{abb:aufgabe34_read_loop}
\end{figure}

\begin{figure}
\lstinputlisting[caption={Assembler-Programm f"ur Zeitmultiplexbetrieb der ADU-Kanäle -- Routine \texttt{read\_loop}}, language=z8asm, label=lsg:aufgabe34_read_loop, firstline=25, lastline=42, firstnumber=25]{aufgabe34.asm}
\end{figure}
...
\begin{figure}
\lstinputlisting[caption={Assembler-Programm f"ur Zeitmultiplexbetrieb der ADU-Kanäle -- Routine \texttt{channel\_read\_and\_output}}, language=z8asm, label=lsg:aufgabe34_channel_read_and_output, firstline=45, lastline=99, firstnumber=45]{aufgabe34.asm}
\end{figure}
