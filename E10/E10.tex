...
Signal & Bedeutung \\
\hline
BUSRQ & Dieses Signal von einer Einheit geliefert, um DMA-Betrieb anzumelden, also das Anforderung des CPU-Bussystems anzufordern. \\
...
Takt & Kontrollbus & Adressbus & Datenbus \\
\hline
38 & MREQ  & \verb|FFF9| & \verb|04| \\
39 & MREQ, RD & \verb|FFF9| & \verb|04| \\
40 & - & \verb|FFF9| & \verb|FF| \\
41 & MREQ & \verb|FFFA| & \verb|00| \\
...
Analog zur vorhergehenden Aufgabe schalten wir in den IM1-Modus (nachtr"aglich stellten wir fest, dass dies "uberfl"ssig ist, da die unterschiedlichen Interrupt-Modi nur beim maskierbaren Interrupt unterschieden werden).
